...
<head>
    ...
    <title>Sachin Enterprise - error page</title>
            ...
            <div class="row justify-content-center text-center">
                <div class="col-md-8">
                    ...
                    <div class="error-content">
                        ...
                        <a class="default-button" href="index.php"><span>Go To Home Page</span></a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="footer-links footer-contact-list">
                        ...
                        <div class="footer-content-card">
                            ...
                            <h5>Email:</h5>
                            <p><a href="/cdn-cgi/l/email-protection#0f7c7a7f7f607d7b4f6e61786e216c6062"><span
                                        class="__cf_email__"
                                        data-cfemail="e0939590908f9294a0818e9781ce838f8d">[email&#160;protected]</span></a>
                            </p>
                        </div>
                        <div class="footer-content-card">
