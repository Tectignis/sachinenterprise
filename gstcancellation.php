...
<head>
  ...
  <title>Sachin Enterprise - GST Cancellation INR 299/- Only 4 days</title>
    ...
    <div class="row">
      ...
      <div class="setion-content">
        <div class="row justify-content-center pt-5">
          <div class="col-8">
            <label>In case you want to cancel your GST registration because GST is not applicable to you or because you
              are closing down your business or profession. Or there is some other valid reason due to which you want to
              <b>cancel your GST registration</b>, sachinenterprise will help you with an end-to-end advisory.</label>
          </div>
        </div>
        <div class="row justify-content-center pt-3">
          <div class="col-8 pb-5">
            <label>To cancel a GST registration, an application must be submitted on the GST Common Portal in FORM GST
              REG-16 along with the required information. On submission of an application for cancellation of GST
              registration, the GST officer is required to verify the application and issue an order in FORM GST REG-19,
              within 30 days from the date of application.</label>
          </div>
        </div>
