      ...
      <div class="card" style="border:none">
        ...
        <div class="container">
            ...
            <div class="setion-content">
                <div class="row justify-content-center pt-3">
                    <div class="col-10">
                        <label for="">The International Accreditation Forum has officially launched the world's exclusive global database for accredited management system certifications, providing businesses and governments the ability to digitally validate an organization’s certification(s) to determine if a certificate is valid and if the Certification Body issuing the certificate is accredited to issue certifications to that standard. You can visit <strong>Official Website at www.iaf.nu Official Website to verify the iaf iso certificate is https://www.iafcertsearch.org/</strong></label>
                    </div>
                    </div>
                </div>
            </div>
            ...
            <div class="setion-content">
                <div class="row justify-content-center pt-5">
                    <div class="col-6 pt-5">
                        <label for=""><i class="fas fa-check"></i> Business Registration Proof: Certificate of Incorporation or GST certificate or MSME certificate or Trademark certificate, etc. (Any One)</label>
                        <label for=""><i class="fas fa-check"></i> Letter Head or Visiting Card (Any One).</label>
                        <label for=""><i class="fas fa-check"></i> Sales Invoice, Purchase Invoice, Receipt, Bill (Any One).</label>
                        <label for=""><i class="fas fa-check"></i> Business Activity/Scope (Which is to be written on certificate).</label>
                    </div>
                    <div class="col-6">
