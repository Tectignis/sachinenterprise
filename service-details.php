...
<a href="#" class="nav-link dropdown-toggle">Home <i class="fas fa-angle-down"></i></a>
...
<li class="nav-item">
<a href="#" class="nav-link dropdown-toggle active">Services <i class="fas fa-angle-down"></i></a>
<ul class="dropdown-menu">
<li class="nav-item">
...
<li class="nav-item"><a href="service-details.html" class="nav-link active">Service Details</a></li>
</ul>
</li>
<li class="nav-item">
<a href="#" class="nav-link dropdown-toggle">Pages <i class="fas fa-angle-down"></i></a>
<ul class="dropdown-menu">
...
<li class="nav-item">
<a href="#" class="nav-link dropdown-toggle">Blog <i class="fas fa-angle-down"></i></a>
<ul class="dropdown-menu">
...
<ul>
<li><button class="popup-button"><i class="fas fa-search"></i></button></li>
<li><a class="default-button default-button-3" href="contact.html"><span>Get Started</span></a></li>
</ul>
</div>
</div>
</nav>
...
<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamc laboris nisi ut aliquip commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur commodo. Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatem necessitatibus dolor placeat fuga deleniti doloremque? Ratione officia quia aliquam possimus.</p>
<p>Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium sed doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut.</p>
...
<h3>Categories</h3>
<ul>
<li><a class="active" href="service-details.html"><i class="fas fa-angle-double-right"></i> Residential</a></li>
<li><a href="service-details.html"><i class="fas fa-angle-double-right"></i> Commercial</a></li>
<li><a href="service-details.html"><i class="fas fa-angle-double-right"></i> Construction</a></li>
<li><a href="service-details.html"><i class="fas fa-angle-double-right"></i> Windows</a></li>
<li><a href="service-details.html"><i class="fas fa-angle-double-right"></i> Carpet</a></li>
<li><a href="service-details.html"><i class="fas fa-angle-double-right"></i> Furniture</a></li>
</ul>
</div>
...
<h5>Email:</h5>
<p><a href="/cdn-cgi/l/email-protection#691a1c1919061b1d2908071e08470a0604"><span class="__cf_email__" data-cfemail="f2818782829d8086b2939c8593dc919d9f">[email&#160;protected]</span></a></p>
</div>
<div class="footer-content-card">
...
<script data-cfasync="false" src="../../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min-7.js"></script><script src="assets/js/jquery-3.6.0.min.js"></script>
