        ...
        <div class="container">
            ...
            <div class="setion-content">
                <div class="row justify-content-center pt-5">
                    <div class="col-8">
                        <label><b>GST Registration</b> is applicable on all goods and services except Petroleum products as of now. Goods & Service Tax (GST) is a consolidated tax, which essentially means that State and Central Indirect taxes have been merged. Entire country now operates under a uniform tax system. It now replaces service tax, excise, VAT, entertainment tax, luxury tax, octroi, CST etc.</label>
                    </div>
                    </div>
                <div class="row justify-content-center pt-3">
                        <div class="col-8">
                            <label> GST Registration Process  in India is completely online. It requires no manual intervention or no physical paper submissions. A very simple procedure has been prescribed for GST Registration.</label>
                        </div>
                        </div>
                        <div class="row justify-content-center pt-3">
                        <div class="col-8">
                            <label>  The GST exemption limit earlier was Rs 20 lakhs for all the businesses and services. But now with latest amendment Businesses with an annual turnover of up to <b>Rs 40 lakh are exempted from GST. Additionally, those with a turnover up to Rs 1.5 crore can opt for the Composition Scheme and pay only 1% tax. However, for services the exemption limit of turnover is still 20 lakhs. Also, service provider having turnover up to 50 lakhs can opt for composition scheme for services and pay only 6% of tax.</b></label>
                                </div>
                        </div>
                        <div class="row justify-content-center pt-3">
                        <div class="col-8">
                                <label><b>Hence, it would be compulsory to get GST registered only</b> for traders, manufacturers, businesses, individuals, professionals etc, whose turnover (sales) exceed INR 40 Lakh. If your sales are less than INR 40 Lakh, you may also voluntarily opt for GST Registration in case you wish to avail the benefits of Input Tax Credit. Further, all persons who make interstate purchase or sales of services or goods have to apply for GST registration. Above limits do not apply to them.</label>
                                </div>
                        </div>
                        <div class="row justify-content-center pt-3 ">
                        <div class="col-8">
                        ...
                        <div class="row justify-content-center pt-3">
                        <div class="col-8">
                                        </label> A new system for new GST registration has been introduced and activated from 21st August, 2020 where the Aadhaar card is now mandatory for GST registration. That means, the applicant who are seeking for GST registration now will be given an option to select if he wishes to authenticate Aadhaar or wishes to opt for physical verification. If the applicant opts for Aadhaar authentication for his GST registration then the applicant will get his / her GST registration in just three days.</label>
                                </div>
                                </div>
                        <div class="row justify-content-center pt-3">
                        <div class="col-8">
                        ...
                        <div class="col-8">
                              <label for=""><b>2.</b>He would be legally authorized to collect tax from his customers and pass on the credit of the taxes paid on the goods or services supplied to the purchasers/ recipients.</label>
                              </div>
                        </div>
                        <div class="row justify-content-center">
                        <div class="col-8">
                                <label><b>3.</b>He can claim input tax credit of taxes paid on his purchases / procurements and can utilize the same for payment of taxes due on supply of goods or services.</label>
                                </div>
                        </div>
                        <div class="row justify-content-center">
                        <div class="col-8">
