    ...
    <div class="terms ptb-100">
        <div class="container">
            ...
            <p>We may collect personal identification information from Users in a variety of ways, including, but not
                ...
                Site. Users may be asked for, as appropriate, name, email address, mailing address, phone number,
                company name. We will collect personal <strong>identification</strong> information from Users only if
                they voluntarily consent such information to us. Users can always refuse to supply personally
            ...
            <p>This site is provided by <strong>Anwa</strong>. <strong>Anwa</strong> collects information in several
            ...
            <ul class="payment">
                <li>Credit Card: <strong>Visa</strong>, <strong>MasterCard</strong>, <strong>Discover</strong>,
                    <strong>American Express</strong>. The total will be charged to your card when the order is shipped.
                </li>
                <li><strong>Anwa</strong> features a Fast Checkout option, allowing you to securely save your credit
            ...
            <ul>
                ...
                <li><span>2.</span> <strong>Anwa</strong> features a Fast Checkout option, allowing you to securely save
