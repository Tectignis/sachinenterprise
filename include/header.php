                ...
                <nav class="navbar navbar-expand-md navbar-light ">
                    ...
                    <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item ">
                                <a href="#" class="nav-link dropdown-toggle">Registration<i
                                        class="fas fa-angle-down"></i></a>
                                <ul class="dropdown-menu ">
                                    <li class="nav-item">
                                        <a href="gstregistration.php" class="nav-link dropdown-toggle">GST Registration
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="gstmodification.php" class="nav-link dropdown-toggle">GST
                                            Modification</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="gstcancellation.php" class="nav-link dropdown-toggle">GST Cancellation
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="esicregistration.php" class="nav-link dropdown-toggle">ESIC
                                            Registration </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="epfregistration.php" class="nav-link dropdown-toggle">EPF
                                            Registration</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="msmeregistration.php" class="nav-link dropdown-toggle">MSME / Udyog
                                            <br>
                            ...
                            <li class="nav-item plus-icon">
                                <a href="#" class="nav-link dropdown-toggle ">Returns<i class="fas fa-angle-down"></i>
                                </a>
                                <ul class="dropdown-menu">
                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a href="tdsreturn-rivision.php" class="nav-link dropdown-toggle">TDS Return
                                            Revision </a>
                                    </li>
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item">
                                        <a href="professionaltaxregi.php" class="nav-link dropdown-toggle">Professional
                                            Tax <br>
                                            Registration </a>
                                    </li>
