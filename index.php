...
<p>Online services are now available at our site , which is the one stop source for all government services. </p>
...
<a class="video-popup" href="../../watch-9.html?v=0qNsC-NLuhM"><i class="flaticon-play-button"></i></a>
 </div>
</div>
</div>
<div class="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12">
...
<p>SACHIN ENTERPRISE SERVICES is an Indian company established in 2016 headquartered in New Mumbai, India.</p>

<div class="about-list">
<ul>
    <li><i class="far fa-check-square"></i>Welcome to the official website of SACHIN ENTERPRISE SERVICES.</li>   
<li><i class="far fa-check-square"></i>The purpose of this portal is to facilitate the listing of online services provided by various government entities under one platform.</li>
...
<h4><a href="service-details.html">Pan Card</a></h4>
<p>Lorem ipsum dolor amet consectetur adipiscing sed do eiusmod tempor incididunt magna labore. magna aliqua dolor sit amet.</p>
...
<p>“ Lorem ipsum dolor sit amet, consectetur dolore adipiscing elitsed eiusmod tempor set incididunt labore dolore magna aliqua Quis ipsum.”</p>
...
<a class="default-button default-button-2" href="pricing.html"><span>Order Plan</span></a>
</div>
</div>
</div>
<div class="col-lg-4 col-md-6 col-sm-12 col-12">
...
<div class="col-lg-4 col-md-6 col-sm-6 col-12">
<div class="news-input-card">
<button class="default-button"><span>Submit</span></button>
 </div>
</div>
</div>
</form>
