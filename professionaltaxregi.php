      ...
      <div class="card" style="border:none">
        ...
        <div class="container">
            ...
            <div class="setion-content">
                <div class="row justify-content-center pt-5">
                    <div class="col-8">
                        <label>Professional tax is a tax levied and collected by the State Government on every single earning individual who earns a living through any medium which can be a profession, trade, calling or employment.</label>
                        <label>In case of the salaried employees, the professional tax needs to be deducted from the salary by the employer on monthly basis and paid to the state government. If an individual is self-employed or in case he has no employer, the individual himself is liable to pay the professional tax.</label>
                    </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="setion-content">
                <div class="row justify-content-center pt-5">
                    <div class="col-6">
                        <label for=""><i class="fas fa-check"></i> In case of delay in obtaining the registration certificate, a penalty of ? 5 per day in case of the employer and ₹ 2 per day in case of a non-employed individual shall be imposed.</label>
                        <label for=""><i class="fas fa-check"></i> In case of delay in payment of professional tax, a penalty of 2% per month of the amount of tax shall be levied. However, in case of non-payment of such professional tax, the assessee would attract an additional penalty of 10% of the amount of tax due.</label>
                        <label for=""><i class="fas fa-check"></i> In case of delay in filing the returns, a penalty of ₹ 1,000 shall be charged if the returns are filed within 1 month after the due date. Where the return is not filed even after 1 month post the due date of filing return, the penalty shall be ? 2,000.</label>
                        <label for=""><i class="fas fa-check"></i> If the information provided by the individual at the time of enrolment is found incorrect or false, it shall attract the penalty of three times of the professional tax payable.</label>
                    </div>
                    <div class="col-6">
