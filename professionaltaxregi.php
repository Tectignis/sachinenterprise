...
if($sql==1){
header("location:professionaltaxregi.php");
}
else
...
<body>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group pt-2">
                                                <input type="text" class="form-control" id="exampleInputPassword1"
                                                   name="phonenumber" placeholder="Phone" minlength="10" maxlength="10" required>
                                            </div>
                                        </div>
                                        <!-- /.card-body -->
    ...
    <div class="container">
        <div class="default-section-title default-section-title-middle">
            <h3 class="pt-5">ABOUT PROFESSIONAL TAX REGISTRATION</h3>
        </div>
        <div class="setion-content">
            <div class="row justify-content-center pt-5">
                <div class="col-8">
                    <label>Professional tax is a tax levied and collected by the State Government on every single
                        earning individual who earns a living through any medium which can be a profession, trade,
                        calling or employment.</label>
                    <label>In case of the salaried employees, the professional tax needs to be deducted from the salary
                        by the employer on monthly basis and paid to the state government. If an individual is
                        self-employed or in case he has no employer, the individual himself is liable to pay the
            ...
            <div class="row justify-content-center pt-5">
                <div class="col-lg-12 col-md-12 col-sm12 col-6">                                                                                             
                    ...
                    <label for=""><i class="fas fa-check"></i> In case of delay in payment of professional tax, a
                        penalty of 2% per month of the amount of tax shall be levied. However, in case of non-payment of
                        such professional tax, the assessee would attract an additional penalty of 10% of the amount of
                        tax due.</label>
                    <label for=""><i class="fas fa-check"></i> In case of delay in filing the returns, a penalty of ₹
                        1,000 shall be charged if the returns are filed within 1 month after the due date. Where the
                        return is not filed even after 1 month post the due date of filing return, the penalty shall be
                        ? 2,000.</label>
                ...
                <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                    <div class="panel panel-default">
                        ...
                        <div id="collapseOne" class="panel-collapse collapse" role="tabpanel"
                            ...
                            <div class="panel-body">
                                <label>Every person engaged actively or otherwise in any profession, trade, callings or
                                    employment and falling under one or the other of the classes mentioned in the second
                                    column of Schedule I appended to Profession Tax Act, is liable to pay Profession
                                    Tax.</label>
                            </div>
                        </div>
                    </div>
                    <div class="panel panel-default">
                        ...
                        <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel"
                            ...
                            <div class="panel-body">
                                <label>The categories of persons liable for Profession Tax are any individual, a Hindu
                                    Undivided Family, firm, company, corporation or other corporate body, any society,
                                    club or association.</label>
                            </div>
                        </div>
                    </div>
                    <div class="panel panel-default">
                        ...
                        <div id="collapseThree" class="panel-collapse collapse" role="tabpanel"
                            ...
                            <div class="panel-body">
                                <label> An employer liable to pay Profession Tax is assessed under Profession Tax Act.
                                    </p>
                            </div>
                        </div>
                    </div>
                    <div class="panel panel-default">
                        ...
                        <div id="collapseFour" class="panel-collapse collapse" role="tabpanel"
                            ...
                            <div class="panel-body">
                                <p>Every employer is liable to deduct Profession Tax (as per the Schedule to the
                                    Profession Tax Act) from the salary/wages paid to his employees & to pay the
                                    Profession Tax so deducted.</label>
                            </div>
                        </div>
                    </div>
                    <div class="panel panel-default">
                        ...
                        <div id="collapseFive" class="panel-collapse collapse" role="tabpanel"
                            ...
                            <div class="panel-body">
                                <p>Every employer who is liable to pay Profession Tax on behalf of his employees, whom
                                    he pays salary/ wages in the taxable limit, is liable to obtain a Certificate of
                                    Registration.</label>
                            </div>
                        </div>
                    </div>
                    <div class="panel panel-default">
                        ...
                        <div id="collapseSix" class="panel-collapse collapse" role="tabpanel"
                            ...
                            <div class="panel-body">
                                <p>The date of liability will be the date on which the employer disburses salary/wages
                                    to any of his employees in the taxable limit, for the first time.</label>
                            </div>
                        </div>
                    </div>
                    <div class="panel panel-default">
                        ...
                        <div id="collapseSeven" class="panel-collapse collapse" role="tabpanel"
                            ...
                            <div class="panel-body">
                                <label>"Salary" or "Wage" includes pay, dearness allowance and all other remunerations
                                    received by any person on regular basis, whether payable in cash or in kind, and
                                    also includes perquisites, and profits in lieu of salary, as defined in section 17
                                    of the Income tax Act, 1961 (43 of 1961); the expression "on regular basis" shall
                                    mean for a period exceeding 180 days in a year.</label>
                            </div>
                        </div>
                    </div>
                    <div class="panel panel-default">
                        ...
                        <div id="collapseEight" class="panel-collapse collapse" role="tabpanel"
                            ...
                            <div class="panel-body">
                                <label> Generally, after a few working days of registration, the user-id and password
                                    (for filling return electronically) can be obtained from the concerned Profession
                                    Tax authority, on production of original RC.</label>
                            </div>
                        </div>
                    </div>
                    <div class="panel panel-default">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div id="collapseTen" class="panel-collapse collapse" role="tabpanel"
                            ...
                            <div class="panel-body">
                                <label>In this case, you will not be able to generate Demat certificate in on-line
                                    process.</label>
                            </div>
                        </div>
                    </div>
